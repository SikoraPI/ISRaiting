...
namespace StudentList.View.Student
{
    /// <summary>
    /// Логика взаимодействия для StudentGraph.xaml
    /// </summary>
    public partial class StudentGraph : UserControl
    {
        private Model.Subject.StudySession StudySession { get; set; }
        private Model.Student.Student Student { get; set; }
        private ObservableCollection<Model.Student.StudentGrades> StudentGrades { get; set; }
        private bool IsGrad { get; set; }
        public StudentGraph(Model.Student.Student Student,Model.Subject.StudySession StudySession, ObservableCollection<Model.Student.StudentGrades> StudentGrades, bool isGrad)
        {
            this.Student= Student;
            this.StudentGrades = StudentGrades;
            this.StudySession= StudySession;
            InitializeComponent();
            Loaded+=FuncGraph_Loaded;
            IsGrad=isGrad;
        }

        private void FuncGraph_Loaded(object sender, RoutedEventArgs e)
        {
            chart.Series.Clear();
            ...
            chart.Titles.Add($"Диаграмма успеваемости студента {Student.FIO}  за {StudySession.AccusativeSession}");
